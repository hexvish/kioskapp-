...
src = r"C:\Users\Vishnu\.gemini\antigravity-ide\brain\a71199bd-28cd-4c69-9062-d10b33e4cc75\ic_launcher_gita_gpt_1786774825913.png"
...
for folder, size in sizes.items():
    ...
    print(f"Updated {size}x{size} icon in {folder}")
